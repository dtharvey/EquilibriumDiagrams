...
ladder_pH = function(pka_list = c(3.128, 4.761, 6.396), 
  ...
  limits = c(0, pkas, 14)
  n = length(pkas)
  col.func = colorRampPalette(c("salmon", "cyan"))
  colors = col.func(n + 1)
  
  # creates default set of labels if labels are not provided
  ...
  if (horiz == FALSE) {
    if (overlay == FALSE) {plot(1, 1, xlim = c(0,14), ylim = c(0,14), 
    ...
    if (buffer == TRUE) {
      ...
      text(0.5, locate - 2.5, "pH = 0", pos = 1, srt = 270)
      text(13.9, locate - 2.5, "pH = 14", pos = 1, srt = 270)
      if (type == "arrow") {
